...
//        public String getImage(int ina){
//            return (new String[] {"9827", "9830", "9829", "9824"}) [this.ordinal()];
//        }
    }

    @Override
    public String toString() {
        int index = (!face.equals("10") ? 1 : 2);
    ...
    public static Card getFaceCard(Suit suit, char abbr){
        ...
        System.out.println("Invalid Face of card selected");
        return null;
    }
